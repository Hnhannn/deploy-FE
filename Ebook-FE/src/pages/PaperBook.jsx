...
import { getBookPrice } from "../service/API_Book_Service";
...
function PaperBook() {
  ...
  useEffect(() => {
    ...
    document.title = "YuKi - Nền tản cung cấp sách ebook";
    const fetchData = async () => {
      try {
        const data = await getBookPrice();
        setBooks(data);
          ...
          <div className="w-full px-14 pt-[5.5rem] absolute top-0 flex gap-x-[42px] min-h-[600px]">
            <div className="w-1/2 z-10 bg-podcast mt-[22px]">
              ...
              <div className="flex mt-10">
                <Link to={`/book-details/${currentBook?.bookID}`}>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    />
                    <p className="text-white-default text-base-16-22 ml-2">
                      Mua sách ngay
                    </p>
                  </button>
                </Link>
